...
import 'package:controle_financeiro/features/transaction/domain/usecases/deposit_money_usecase/deposit_money_usecase_imp.dart';
...
void main() {
  ...
  test(
    ...
    when(() => moneyTransactionRepositoryMock.depositMoney(
            moneyTransactionEntity: depositMoney))
